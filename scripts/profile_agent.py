    ...
    class MockProvider:
        ...
        async def complete(self, messages, tools=None):
            ...
            if call_count == 1:
                return {
                    "content": None,
                    "tool_calls": [{"name": "read_file", "parameters": {"path": "/home/userland/rann-agent/README.md", "limit": 50}}],
                ...
                return {
                    "content": None,
                    "tool_calls": [{"name": "write_file", "parameters": {"path": "/tmp/test.txt", "content": "test"}}],
