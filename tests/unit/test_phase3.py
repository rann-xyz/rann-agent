...
class TestToolExecutor:
    def test_execute_sync_success(self):
        ...
        result = asyncio.run(executor.execute("add", {"x": 2, "y": 3}, my_tool))
    ...
    def test_execute_async_success(self):
        ...
        result = asyncio.run(executor.execute("greet", {"msg": "World"}, async_tool))
    ...
    def test_execute_with_error(self):
        ...
        result = asyncio.run(executor.execute("fail", {}, failing_tool))
...
class TestToolDiscovery:
    ...
    def test_register_custom_tool(self):
        ...
        discovery.register(
            "double", my_custom_tool, description="Doubles a number", risk_level="low"
        )
