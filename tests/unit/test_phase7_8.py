...
from rann_agent.core.exceptions import PathTraversalError
...
class TestCommandValidator:
    ...
    def test_block_dangerous_patterns(self):
        ...
        for cmd in dangerous:
            _allowed, _ = v.validate_command(cmd)
...
class TestInputValidator:
    def test_validate_string(self):
        v = InputValidator()
        valid, _msg = v.validate_string("hello")
        assert valid

    def test_reject_empty(self):
        v = InputValidator()
        valid, _msg = v.validate_string("")
        assert not valid
...
class TestSecretDetector:
    ...
    def test_detect_no_secrets(self):
        d = SecretDetector()
        d.detect("Hello, this is normal text")
