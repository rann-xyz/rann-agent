...
class CacheManager:
    ...
    async def get_llm_response(self, messages: list) -> dict | None:
    ...
    async def get_tool_result(self, tool_name: str, parameters: dict) -> dict | None:
    ...
    async def set_tool_result(self, tool_name: str, parameters: dict, result: dict):
        ...
        try:
            if self.client:
                ...
                await self.client.setex(key, 300, json.dumps(result))
            else:
