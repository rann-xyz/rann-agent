"""
Session-based workspace isolation for RANN Public Agent
"""
import os
import time
import secrets
...
class WorkspaceIsolator:
    ...
    @classmethod
    def create_session_workspace(cls, session_id: str, base_workspace: str = "/home/userland/rann-agent") -> Path:
