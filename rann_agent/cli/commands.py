...
def shell_cmd():
    ...
    # Handled below as a real command
...
def register_shell(cli):
    ...
    def shell(workspace: str | None, max_iterations: int):
...
def register_memory_commands(memory_group):
    ...
    @click.option("--force", is_flag=True, help="Skip confirmation")
    def memory_clear(mem_type: str | None, force: bool):
    ...
    def memory_add(content: str, mem_type: str, key: str | None):
    ...
    def memory_export(filepath: str, mem_type: str | None):
...
def register_project_commands(cli):
    ...
    def project_init(path: str, name: str | None, language: str | None):
    ...
    def serve(port: int, host: str):
        ...
        try:
            ...
            with socketserver.TCPServer((host, port), Handler) as httpd:
                click.echo("🌐 RANN Agent Web Interface")
...
def register_context_commands(cli):
    ...
    def context_cmd(action: str | None, content: str | None):
