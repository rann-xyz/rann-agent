...
class VectorMemory:
    ...
    async def update(self, memory_id: str, content: str, metadata: dict | None = None):
    ...
    async def search_by_metadata(
        self, filters: dict[str, Any], n_results: int = 10
    ) -> list[dict[str, Any]]:
        ...
        try:
            results = self.collection.get(where=filters, limit=n_results)
    ...
    async def clear(self, category: str | None = None):
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"total_memories": count, "collection_name": self.collection_name}
        except Exception as e:
