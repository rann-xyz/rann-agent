...
class SkillCurator:
    ...
    async def use_skill(self, skill_id: str, context: dict[str, Any]) -> dict[str, Any]:
        """
    ...
    async def record_skill_outcome(self, skill_id: str, success: bool, feedback: str | None = None):
        ...
        if self.skill_usage.get(skill_id):
    ...
    async def improve_skill(
        ...
        new_lessons: list[str] | None = None,
    ) -> bool:
        """
    ...
    async def export_skill(self, skill_id: str) -> str | None:
