...
class LearningEngine:
    ...
    def learn_from_success(self, task: str, task_type: str, solution: str, verification: str):
        ...
        if solution_key in self.solutions:
            ...
            sol.last_used = datetime.now(UTC).isoformat()
        else:
    ...
    def learn_from_failure(self, task: str, task_type: str, error: str, recovery: str):
    ...
    def get_similar_solution(self, task: str, task_type: str) -> LearnedSolution | None:
