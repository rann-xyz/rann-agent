...
class ToolRegistry:
    ...
    def update(self, name: str, **updates) -> ToolMetadata | None:
        ...
        reg.metadata.updated_at = datetime.now(UTC).isoformat()
        self._save()
    ...
    def deprecate(self, name: str, replacement: str | None = None) -> bool:
