...
class ToolPolicyEngine:
    ...
    def _load_default_policies(self) -> None:
        defaults = {
            ...
            "docker": ToolPolicy(
                "docker", RiskLevel.CRITICAL, PolicyAction.DENY, requires_approval=True
            ),
            "kubernetes": ToolPolicy(
                "kubernetes",
                RiskLevel.CRITICAL,
                PolicyAction.DENY,
            ...
            "database": ToolPolicy(
                "database", RiskLevel.HIGH, PolicyAction.DENY, requires_approval=True
            ),
        }
